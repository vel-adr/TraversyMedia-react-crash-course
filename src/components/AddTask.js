    ...
    return (
        <form className='add-form' onSubmit={onSubmit}>
            ...
            <div className='form-control'>
                ...
                <input type="text" placeholder="Ex: 23 Feb 2021, 13:20" value={day} onChange={(e) => setDay(e.target.value)}></input>
            </div>
            ...
            <input type="submit" value="Add" className='btn btn-block'></input>
        </form>
    )
}
